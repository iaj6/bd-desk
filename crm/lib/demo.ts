...
export const DEMO_TARGETS: Seed[] = [
  {
    ...
    entry_persona: "Ops / Plant leader",
    green_signals: ["PE-owned (Calderwick Capital)", "SQF certified, renewal this year", "Hiring analysts, no data engineers"],
  ...
  },
  {
    ...
    entry_persona: "Ops / Plant leader",
    green_signals: ["PE-owned (Calderwick Capital)", "Recent capacity expansion"],
  ...
  },
  {
    ...
    entry_persona: "Quality / Food Safety leader",
    green_signals: ["PE-owned (Calderwick Capital)", "Roll-up merging quality systems"],
    sources: ["https://example.com/news/bolt-on"],
  },
  {
    company: "Calderwick Capital",
    kind: "contact",
